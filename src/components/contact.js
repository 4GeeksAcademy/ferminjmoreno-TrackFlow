          ...
          <form id="lead-form" class="space-y-5" novalidate>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div>
                ...
                <select id="company-country" name="company_country" class="form-input" required aria-invalid="false" aria-describedby="company-country-error">
              ...
              <div>
                ...
                <select id="product-type" name="product_type" class="form-input" required aria-invalid="false" aria-describedby="product-type-error">
            ...
            <div>
              ...
              <select id="monthly-volume" name="monthly_volume" class="form-input" required aria-invalid="false" aria-describedby="monthly-volume-error">
            ...
            <fieldset aria-describedby="services-error">
