export const Hero = () => `
  <section style="background-color: #0f172a;" class="relative overflow-hidden py-20 lg:py-28 text-white">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
      <div class="space-y-6 lg:col-span-7">
        ...
        <div class="flex flex-col sm:flex-row gap-4 pt-2">
          <a href="#contact" class="inline-flex items-center justify-center px-6 py-3.5 text-base font-semibold rounded-lg bg-emerald-600 text-white hover:bg-emerald-700 transition-smooth shadow-lg">Solicitar informacion</a>
